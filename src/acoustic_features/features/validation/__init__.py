from acoustic_features.features.exceptions.validation import *
from acoustic_features.features.configuration.settings import AcousticFeaturesSettings


class AcousticFeaturesValidation(object):
    """Class implementing the acoustic features validation"""

    # Acoustic features settings
    features_settings = AcousticFeaturesSettings.settings
